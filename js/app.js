(() => {
    ...
    function initSliders() {
        if (document.querySelector(".references-page__slider")) new core(".references-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.22,
            ...
            speed: 800,
            navigation: {
                prevEl: ".references-page__arrow.swiper-button-prev",
                nextEl: ".references-page__arrow.swiper-button-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
